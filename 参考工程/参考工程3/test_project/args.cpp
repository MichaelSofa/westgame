...
DEFINE_string(rec_char_dict_path, "E:/softwares/PaddleOCR/PaddleOCR/ppocr/utils/ppocr_keys_v1.txt",
              "Path of dictionary.");
...
DEFINE_string(layout_dict_path,
              "E:/softwares/PaddleOCR/PaddleOCR/ppocr/utils/dict/layout_dict/layout_publaynet_dict.txt",
              "Path of dictionary.");
...
DEFINE_string(table_char_dict_path,
              "E:/softwares/PaddleOCR/PaddleOCR/ppocr/utils/dict/table_structure_dict_ch.txt",
              "Path of dictionary.");
